...
import com.yuchl.sell.repository.OrderDetailRepository;
import com.yuchl.sell.repository.OrderMasterRepository;
...
import com.yuchl.sell.utils.KeyUtil;
...
//            cartDTOList.add(cartDTO);
    ...
    public Page<OrderDTO> findList(String buyerOpenid, Pageable pageable) {
        ...
        Page<OrderDTO> orderDTOPage = orderMasterPage.map(orderMasterMapper::toDto);
        return orderDTOPage;
    }
    ...
    public OrderDTO cancel(OrderDTO orderDTO) {
        ...
        OrderMaster updateResult = orderMasterRepository.save(orderMasterMapper.toEntity(orderDTO));
        if (updateResult == null) {
            log.error("【取消订单】更新失败, orderMaster={}", orderDTO);
