...
public class OrderServiceTest {
    ...
    private final String ORDER_ID = "1539613008118198413";

    @Test
    public void create() {
        OrderDTO orderDTO = new OrderDTO();
        orderDTO.setBuyerName("龙哥");
        orderDTO.setBuyerAddress("自学网");
    ...
    public void findList() {
        ...
        log.info("result context: {}; Total: {}; page: {}", result.getContent(), result.getTotalElements(), result.getTotalPages());
